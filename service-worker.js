const CACHE="vardiyacep-v1.4.0";
const APP_SHELL=["./","./index.html","./styles.css?v=1.4.0","./app.js?v=1.4.0","./manifest.webmanifest","./sample-data.json","./icons/icon-192.png","./icons/icon-512.png"];
